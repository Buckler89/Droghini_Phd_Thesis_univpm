...
\begin{document}
	\thispagestyle{empty}
		...
		\addplot [color=black,fill=darkgray] coordinates {(Aerial,84.57) (FAS,85.94)  };
		\addplot [color=black,fill=gray] coordinates {(Aerial,84.49) (FAS,89.93) };
		\addplot [color=black,fill=lightgray] coordinates {(Aerial,78.22) (FAS,89.24) };		
