...
%		\centering
		...
		\addplot [color=black,fill=rred] coordinates {(Aerial,91.56) (FAS,98.04)  };
		\addplot [color=black,fill=ccian] coordinates {(Aerial,91.20) (FAS,95.42) };
		\addplot [color=black,fill=yyellow] coordinates {(Aerial,91.16) (FAS,98.06) };		
