...
%			FAS		85.17	90.82	88.67
		...
		\addplot [color=black,fill=darkgray] coordinates {(Aerial,85.28) (FAS,85.17)  };
		\addplot [color=black,fill=gray] coordinates {(Aerial,83.35) (FAS,90.82) };
		\addplot [color=black,fill=lightgray] coordinates {(Aerial,81.03) (FAS,88.67) };
